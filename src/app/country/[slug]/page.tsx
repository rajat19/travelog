...
export default async function CountryPage({ params }: CountryPageProps) {
  ...
  return (
    <div>
      ...
      <ParallaxHero imageSrc={country.coverImage} imageAlt={country.name} height="50vh">
        <Link
          href="/"
      ...
      {/* City Timeline (for countries with 2+ cities) */}
          ...
          <section className="border-t border-base-300 bg-base-200/30 py-12">
            <div className="container mx-auto px-4">
              ...
              <div className="mx-auto max-w-3xl">
                <CityTimeline cities={country.cities} countrySlug={country.slug} />
              </div>
            </div>
          </section>
        </AnimatedSection>
